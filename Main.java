...
public class Main extends Application {
    ...
    private int screenX, screenY, ph, pw, points, count, count2, counter, listInc, sniper;
    ...
    private Text t1, t2, t3, livePoints, sniperText;

    @Override
    public void start(Stage stage) throws Exception{

        stage.setTitle("Invading Space (Krister Iversen)");
        ...
        sniperText = new Text();
        sniperText.setFont(Font.font("Arial", FontWeight.NORMAL, 50));
        sniperText.setFill(Color.BLUEVIOLET);
        ...
        root.getChildren().add(sniperText);
        livePoints.setLayoutX(50);
        livePoints.setLayoutY(50);
        livePoints.setText("0");
        sniperText.setLayoutX(50);
        sniperText.setLayoutY(200);
        sniperText.setText("Sniper ready");
    ...
    // Increment tellet for lagring av top 10
    public int cng(){
        return counter++;
    }

    public int getListInc(){
        return listInc++;
    }
    ...
    private void shoot(){
        ...
        shot.setLayoutY(iv.getLayoutY()+75);
        FadeTransition ft = new FadeTransition(Duration.millis(200), shot);
        ft.setFromValue(0.0);
        ft.setToValue(1);
        ft.play();
        FadeTransition ft2 = new FadeTransition(Duration.millis(200), shot);
        ft2.setFromValue(1);
        ft2.setToValue(0.0);
        ft2.play();
    ...
    private class Runner extends AnimationTimer {
        ...
        public void handle(long l) {
            ...
            if(change2>1e9){ // En gang per sekund
                ...
                if(sniper>1){
                    sniper--;
                    sniperText.setText("Sniper up in "+sniper);
                } else {
                    sniperText.setText("Sniper ready");
                    canShoot = true;
                }
    ...
    public void save(){
        try {
            ...
            lbl.forEach((v)-> sb.append(getListInc()).append(" | ").append(v.toString()).append("\n"));
